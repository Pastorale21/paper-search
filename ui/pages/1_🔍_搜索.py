...
top_k = cols[1].slider("返回数量 (Top-K)", min_value=3, max_value=20, value=10)
...
if mode == "paper":
    query = st.text_area("查询", height=140, placeholder=placeholder)
else:
    query = st.text_input("查询", placeholder=placeholder)
